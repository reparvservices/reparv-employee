...
const DigitalBroker = () => {
  ...
  const [selectedDigitalBroker, setSelectedDigitalBroker] = useState(
            ...
            <div className="grid gap-6 md:gap-4 grid-cols-1 lg:grid-cols-2">
              ...
              <div className={`${enquiry.dbName ? "block" : "hidden"} w-full`}>
                ...
                <input
                  ...
                  className="w-full mt-[10px] text-[16px] font-medium p-4 border border-[#00000033] rounded-[4px] focus:outline-none focus:ring-2 focus:ring-blue-500"
                  value={
                    (enquiry.dbName ? enquiry.dbName + " - " : "No ") +
                    (enquiry.dbContact ? enquiry.dbContact : "Broker")
                  }
                  readOnly
                />
              </div>
