...
const MultiStepForm = ({
  ...
  const { URI, user, setLoading, showPropertyForm, setShowPropertyForm } = useAuth();
  ...
  const handleFinalSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await fetch(`${URI}/${user?.projectpartnerid ? "employee":"admin"}/properties/${endpoint}`, {
